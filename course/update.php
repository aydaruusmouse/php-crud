...
$id= $_GET['updateid'];  
     ...
     $dhaman= "select * from course where id= $id";
...
if(isset($_POST['submit'])){
    $name= $_POST['name'];
    $credit= $_POST['credit'];
    $sql= "update course set course_name= '$name', credit_hour= '$credit' where id= '$id'";
...
<form  method="POST">
  ...
  <div class="form-group container">
    ...
    <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Credits" name="credit" value= <?php echo $credit ?>>
  </div>
  <div class="container">
