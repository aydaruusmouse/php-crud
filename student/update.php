...
$id= $_GET['updateid'];  
     ...
     $dhaman= "select * from student where id= $id";
...
if(isset($_POST['submit'])){
    ...
    $email= $_POST['email'];
    $class= $_POST['class'];
    $sql= "update student set name= '$name', phone= '$phone', email= '$email', class= '$class' where id= '$id'";
...
<form  method="POST">
  ...
  <div class="form-group container">
    ...
    <input type="text" class="form-control" id="exampleInputPassword1" placeholder="class" name="class" value= <?php echo $class ?> >
  </div>
